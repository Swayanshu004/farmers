...
function News() {
  return (
    <div className='w-screen py-10 flex flex-wrap justify-center'>
        <div className='w-full md:w-1/3 h-56 py-20 bg-lime-300 rounded-3xl mx-10 my-5'>
            <h1 className='text-2xl md:text-5xl font-bold text-center'>NEWS-1</h1>
        </div>
        <div className='w-full md:w-1/3 h-56 py-20 bg-gray-500 rounded-3xl mx-10 my-5'>
